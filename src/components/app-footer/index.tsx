import React, { memo, type ReactNode, Fragment } from "react";
import { FooterLeft, FooterRight, AppFooterStyle } from "./style";
import { footerLinks, footerImages } from "@/assets/data/local-data";

interface AppFooterPropsType {
  children?: ReactNode;
}

const AppFooter: React.FC<AppFooterPropsType> = memo(() => {
  return (
    <AppFooterStyle>
